...
//                         © 2025
//                         <a href="https://www.linkedin.com/in/bhupesh-jha-09aa5323a/" className="hover:underline">
//                              Bhupesh Jha
//                         </a>
//                         . All Rights Reserved.
//                     </span>
            ...
            <div className="mx-auto w-full max-w-screen-xl p-6 lg:p-8">
                ...
                <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center text-center sm:text-left">
                    ...
                    <div className="flex mt-4 sm:mt-0 space-x-5">
                        {[
                            { name: "Facebook", href: "#", icon: "M6.135 3H8V0H6.135..." },
                            { name: "Discord", href: "#", icon: "M16.942 1.556a16.3 16.3 0 0 0..." },
                            { name: "Twitter", href: "#", icon: "M20 1.892a8.178 8.178 0 0 1..." },
                            { name: "GitHub", href: "#", icon: "M10 .333A9.911 9.911 0 0 0 6.866 19.65..." },
                        ].map((item, index) => (
                            <Link key={index} to={item.href} className="text-gray-500 hover:text-gray-900">
